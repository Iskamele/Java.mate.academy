...
import section00_DailyTasks.JavaCore.Easy.T25_CountSheep.CountSheep;
...
public class CountSheepTest {
    ...
    public void countSheep_CountRandomSheep() {
        ...
        Assert.assertEquals("Your method should return a murmur for a random number of sheep\n",
                expected, CountSheep.countSheep(randomNum));
    }
