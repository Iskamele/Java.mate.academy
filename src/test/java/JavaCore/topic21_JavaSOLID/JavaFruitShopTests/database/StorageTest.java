package JavaCore.topic21_JavaSOLID.JavaFruitShopTests.database;
...
public class StorageTest {
    ...
    @Test
    public void getFruitStorage_putAndGetInStorage_Ok() {
        assertEquals("Test failed! The storage should return the value \"" + FIRST_QUANTITY + "\" with the key \"" + FRUIT + "\"",
                FIRST_QUANTITY, Storage.getFruitStorage().getOrDefault(FRUIT, DEFAULT_QUANTITY).intValue());
    }
    ...
    public void getFruitStorage_putAndUpdateExistingFruit_Ok() {
        ...
        assertEquals("Test failed! The value in the storage should have been updated to be: " + (FIRST_QUANTITY + SECOND_QUANTITY),
