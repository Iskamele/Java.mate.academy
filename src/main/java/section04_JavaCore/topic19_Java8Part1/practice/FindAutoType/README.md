Implement the suitable functional interface and override its method that should take the `Integer` value that represents the car weight, and return the certain `AutoType` depending on this weight.
