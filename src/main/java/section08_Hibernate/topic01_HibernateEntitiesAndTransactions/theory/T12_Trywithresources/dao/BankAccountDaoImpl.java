...
import section08_Hibernate.topic01_HibernateEntitiesAndTransactions.theory.T12_Trywithresources.util.HibernateUtil;
...
public class BankAccountDaoImpl implements BankAccountDao {
    ...
    public void transfer(BankAccount sender, BankAccount receiver, BigDecimal amount) {
        ...
        /** Try With Resources закрывается раньше, чем блок catch успевает отработать
         и это неправильно! */
